        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IssuedNumber = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Claim_role", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Claim_role_Role_RoleId",
                        column: x => x.RoleId,
                        principalTable: "Role",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Claim_user", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Claim_user_User_UserId",
                        column: x => x.UserId,
                        principalTable: "User",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Claim_role_RoleId",
                table: "Claim_role",
                column: "RoleId");

            migrationBuilder.CreateIndex(
                name: "IX_Claim_user_UserId",
                table: "Claim_user",
                column: "UserId");
